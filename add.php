...
//l’appel à la base 
 ...
 // On va demander à l’utilisateur d’insérer des données, qu’il faudra traiter et sécuriser.
 //traiter la méthode du formulaire, vérification de la soumission puis test des inputs un a un  :
 if($_SERVER["REQUEST_METHOD"]== "POST" && !empty($_POST)){
//assignation d' une variable d’erreur
$nameError = null;
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST)) {
    ...
    if ($valid) {
        ...
        $sql = "INSERT INTO test (name,firstname,age,tel, email, pays,comment, metier,url) values(?, ?, ?, ? , ? , ? , ? , ?, ?)";
        $q = $pdo->prepare($sql);
